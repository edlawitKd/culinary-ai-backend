...
class Plan(models.Model):
    ...
    duration_days = models.PositiveIntegerField(default=30)  # 30 for monthly, 365 for yearly
...
class Subscription(models.Model):
    ...
    end_date = models.DateTimeField(null=True, blank=True)  # allow NULL
    is_active = models.BooleanField(default=False)

    def save(self, *args, **kwargs):
        # Only calculate end_date if start_date exists
